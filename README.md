...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/lcvhihWCWX)
...
```sh
npx nx serve sell-sheet
```

To create a production bundle:

```sh
npx nx build sell-sheet
```

To see all available targets to run for a project, run:

```sh
npx nx show project sell-sheet
```
